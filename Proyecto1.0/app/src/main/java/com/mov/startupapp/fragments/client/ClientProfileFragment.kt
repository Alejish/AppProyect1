package com.mov.startupapp.fragments.client
...
import com.mov.startupapp.activities.ProfileUpdateActivity
...
class ClientProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        sharedPref = SharePref(requireActivity())
    ...
    private fun goToUpdate() {
        val i = Intent(requireContext(), ProfileUpdateActivity::class.java)
        startActivity(i)
    }
